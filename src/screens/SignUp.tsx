      ...
      <form id="sib-form" method="POST" action="https://f261eed8.sibforms.com/serve/MUIFAOemvK9thqVxmi_0nOw0h_5iqdlmUB9nsoUk4fCMy5D3pfi-E21RovraavOT_XasAksNSWXqJjgiol5S2aC2Y2tx95jd2ZcWY1nYu7RaVQ9G67bjkJNwtbXkIoLbWLpLba-xwY4FYSWQfGwFqrh9oevNdBU1Fpmxodgb_15a3MeJWxAbEXKXsHamwo8FOboEoR2ebjI_o3b7" data-type="subscription">
          ...
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; color:#0C0B0A;" for="FIRSTNAME" data-required="*">First name</label>
        ...
        <div style="padding: 8px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; color:#0C0B0A;" for="EMAIL" data-required="*">Email</label>
                <div class="entry__field">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="text-align: center">
            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:center; color:#154618; background-color:#a0d766; border-width:0px; border-radius:15px; width:100%; height:50px;" form="sib-form" type="submit">
...
function ensureBrevoStyles() {
  if (document.getElementById('brevo-overrides')) return;
  const style = document.createElement('style');
  style.id = 'brevo-overrides';
  style.textContent = `
    @font-face {
      font-display: block;
      font-family: Roboto;
